...
export const MoviePage = () => {
  ...
  const hasAnyItems =
    trending.length || topRated.length || nowPlaying.length || bollywood.length;
  ...
  return (
    <div className="bg-[#0a0a0a] text-white min-h-screen">
      ...
      <div className="pt-[60px] md:pt-[68px]">
        <HeroSection
          items={trending.filter((i) => i.backdrop).slice(0, 6)}
          loading={loading}
          title="Movie World"
          subtitle="Trending, top-rated and blockbuster movies"
        />
            ...
            <>
              <div className="px-4 sm:px-8 lg:px-16 pb-10">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="bg-gradient-to-r from-emerald-500 to-teal-500 text-[10px] font-bold px-2 py-0.5 rounded-full text-white animate-pulse">
                    LIVE
                  </span>
                </div>
              ...
              <div className="px-4 sm:px-8 lg:px-16 pb-10">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="bg-gradient-to-r from-amber-500 to-orange-500 text-[10px] font-bold px-2 py-0.5 rounded-full text-white">
                    IN THEATERS
                  </span>
                </div>
